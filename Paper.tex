...
\vspace{-2em}\centering
  \fbox{
    \includegraphics[width=0.36 \textwidth]{assets/final/straightMountain}}    \vspace{-1.8em}
    \caption{Straight Learning Path}\label{fig:straight}
    \vspace{5pt}  
      \fbox{\includegraphics[width=0.37 \textwidth]{assets/final/curvyMountain}}
      \vspace{-1.8em}
...
and ultimately make the most out of the presentation.\ednote{This intro does not work for
  math. Math instruction is mostly done via blackboard, and teachers can flexibly take any
  path they want with that in response to student understanding (or lack, ... ). Maybe we
  can turn this around: math uses blackboard, because it is flexible. Presentations are
  too inflexible for math, let's make them better.}
...
\begin{wrapfigure}{l}{.55\textwidth}\centering\vspace{-2em}
  \fbox{\includegraphics[width=0.55\textwidth]{assets/final/Architecture}} 
  \vspace{-1em}
...
\begin{wrapfigure}l{.65\textwidth}\vspace{-2em}
  \fbox{\includegraphics[width=0.65\textwidth]{assets/final/inclusionGraphPythagorean}} 
...
\begin{figure}[ht]\centering
  \fbox{\includegraphics[width=0.97\textwidth]{assets/final/primaryNarrativePath2}}
  \vspace{-.5em}
...
\begin{figure}[ht]\vspace{-1em}
  \fbox{\includegraphics[width=0.97\textwidth]{assets/final/dependencyGraphPythTheo2}} 
  \vspace{-.5em}
  \caption{Dependency Graph}\label{fig:depGraphPythagoreanFull}
\end{figure}

\begin{wrapfigure}r{.67\textwidth}\vspace{-2em}
  \fbox{\includegraphics[width=0.67\textwidth]{assets/final/fullPresentation2}} 
  \vspace{-1em}
...
\begin{wrapfigure}r{.63\textwidth}\vspace{-2em}
  \fbox{\includegraphics[width=0.6\textwidth]{assets/final/levels}} 
  \vspace{-1em}
...
\begin{wrapfigure}{l}{0.43\textwidth}\vspace{-2em}
  \fbox{\includegraphics[width=0.4\textwidth]{assets/final/60degree}} 
  \vspace{-.5em}
