...
\vspace{-2.1em}\centering
  \fbox{
    \includegraphics[width=0.37 \textwidth]{assets/final/straightMountain}}    \vspace{-1.8em}
    \caption{Straight Learning Path}\label{fig:straight}
    \vspace{5pt}  
      \fbox{\includegraphics[width=0.38 \textwidth]{assets/final/curvyMountain}}
      \vspace{-1.8em}
...
\begin{wrapfigure}l{.65\textwidth}\vspace{-2em}
  \fbox{\includegraphics[width=0.63\textwidth]{assets/final/inclusionGraphPythagorean}} 
  \vspace{-1.8em}
