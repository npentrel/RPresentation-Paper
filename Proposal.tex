...
Visual and normal tree-like graph language have different primitives and it is interesting how one can be mapped to the another. When we consider tree-like graphs, there are two structural primitives, namely the nodes/ concepts and the relations between nodes. Additionally we can add semantic primitives like attributes to the concepts and to the relations. These structural primitives and semantic primitives provide the basics that graphs can be built on.\\
