...
\vspace{-26pt}
  \begin{center}
  \fbox{
    \includegraphics[width=0.45\textwidth]{assets/Annie4xml}
    }
  \end{center}
\vspace{-20pt}
  \caption{Information in ???}
  \label{fig:Annie-Omdoc}
\vspace{-10pt}
\end{wrapfigure}
...
\ednote{on top of the info about when it appears within the course.}
...
\vspace{-26pt}
  \begin{center}
  \fbox{
    \includegraphics[width=0.45\textwidth]{assets/Annie4ancient2}
    }
  \end{center}
\vspace{-20pt}
