...
\begin{figure}[H]
        \centering
                \fbox{\includegraphics[width=0.8\textwidth]{model}}
...
\begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.3\textwidth}
                \fbox{\includegraphics[width=\textwidth]{size-of-objects}}
        ...
        \begin{subfigure}[b]{0.3\textwidth}
                \fbox{\includegraphics[width=\textwidth]{relation}}
...
\ednote{ These are things I derive from what I have been teaching my APS seminars and have probably been told by multile people during my training as a prezi ambassador. Do I need to cite my teaching material? Not sure...}
...
\ednote{Expressive Adequacy, Reasoning Efficiency, Primitives, Meta-representation, and Incompleteness}
