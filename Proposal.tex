...
\ednote{
not towards a semantic representation of data but towards representing the network and context to not display information but represent knowledge http://rhizomik.net/html/~roberto/thesis/html/KnowledgeRepresentation.html}
\ednote{Knowledge Representation in the Social Semantic Web} 
\ednote{Include in introduction Statement and Motivation of Research  } 
