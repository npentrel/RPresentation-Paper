...
\section{Work Plan}
\subsection{WP1: Understand API of Prezi or similar software}
...
\ednote{When do I feel successful?\\
-running system (or I can tell why it didn't/couldn't work) \& \\
-users can understand it and reconstruct the original graph. }
