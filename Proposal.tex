...
Perform qualitative analysis of the visualization produced by the implementet \sys. Determine whether the implemented \sys meats the goals that were outlined in the Evaluation Criteria. Measure the speed of the system.
\ednote{SMART goals?}
\newpage
