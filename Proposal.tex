...
If this research is successful one could envision connecting all of Mathematics or other fields in a way that allows students to go back to the concepts they have forgotten to understand the topics currently covered in class. As such it will foster learning and could transform how we interact with course material as a whole. It is easy to see that this research would also have many other real world applications anywhere where knowledge is supposed to be transferred.\\ 
